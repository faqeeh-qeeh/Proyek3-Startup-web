        ...
        <div class="col-lg-8 col-md-10">
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white border-0 py-3">
                    <h5 class="card-title text-center mb-0 fw-bold">Register Akun Client</h5>
                </div>
                    ...
                    <form method="POST" action="{{ route('client.register') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="full_name" class="form-label small text-muted">Nama Lengkap</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="email" class="form-label small text-muted">Email aktif</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="whatsapp_number" class="form-label small text-muted">Nomor WhatsApp</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="gender" class="form-label small text-muted">Jenis Kelamin</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="birth_date" class="form-label small text-muted">Tanggal Lahir</label>
                        ...
                        <div class="mb-3">
                            <label for="address" class="form-label small text-muted">Alamat Lengkap</label>
